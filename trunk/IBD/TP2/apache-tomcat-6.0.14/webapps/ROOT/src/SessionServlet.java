/*
 * SessionServlet.java - Edited by Sara Bouchenak 2007/10/31
 */
...
public class SessionServlet extends HttpServlet {
    ...
    public void doGet (HttpServletRequest req, HttpServletResponse res)
	  ...
	  out.println("<HEAD><TITLE> SessionServlet Example </TITLE></HEAD><BODY>");
	  out.println("<h1> SessionServlet Example </h1>");
