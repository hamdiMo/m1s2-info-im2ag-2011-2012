 ...
 * @version 1.0
 */
public class EditCategorieDialog extends javax.swing.JDialog {
  public EditCategorieDialog(Frame parent) {
    super(parent, true);
    ...
    setSize(403, 165);
    setVisible(false);
    JLabel0.setText("Categorie:");
    getContentPane().add(JLabel0);
    JLabel0.setBounds(12, 12, 72, 24);
    JLabel1.setText("Nouveau Nom:");
    getContentPane().add(JLabel1);
    JLabel1.setBounds(12, 48, 72, 24);
    JLabel2.setText("Prix:");
    getContentPane().add(JLabel2);
    JLabel2.setBounds(12, 74, 72, 24);
    _uid0.setText("categorie a modifier");
    getContentPane().add(_uid0);
    _uid0.setBounds(84, 12, 312, 24);
    _uid.setText("categorie");
    getContentPane().add(_uid);
    _uid.setBounds(84, 48, 312, 24);
    _pwd.setText("prix");
    getContentPane().add(_pwd);
    _pwd.setBounds(84, 74, 312, 24);
    _ok.setText("OK");
    getContentPane().add(_ok);
    _ok.setBounds(60, 110, 84, 24);
    _cancel.setText("Cancel");
    getContentPane().add(_cancel);
    _cancel.setBounds(264, 110, 84, 24);
    //}}
   ...
   * The user ID entered.
   */
  javax.swing.JTextField _uid0 = new javax.swing.JTextField();
   ...
   */
  javax.swing.JTextField _pwd = new javax.swing.JTextField();
  ...
  String getOldCategorie() {
	  return _uid0.getText();
  }
