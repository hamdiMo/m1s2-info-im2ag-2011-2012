...
create table LesRepresentations (numS number (4), dateRep timestamp,
...
create table LesTickets (noSerie number (4), numS number (4),  
      dateRep timestamp, noPlace number (4), noRang number (4), 
      dateEmission timestamp, noDossier number (4), 
